...
const roles = ref([
  ...
  { id: 2, name: '企业端', value: 'company' },
  { id: 3, name: '管理员', value: 'admin' },
])

function onSwitchRole(value: string) {
  return value
}
</script>
    ...
    <div class="flex flex-col gap-16">
      <template v-for="r in roles" :key="r.id">
        <div class="pos-relative">
          <VanCell size="large" :title="r.name" clickable class="items-center gap-8 rounded-bl-3xl rounded-tr-3xl border-none!" :border="false" @click="onSwitchRole(r.value)">
            <template #icon>
            ...
            <template #value>
              <div class="append">
                ...
                <div class="pos-absolute right-0 top-0 h-15 w-80 flex items-center justify-center rounded-bl-3xl bg-[rgb(228,161,83)]">
